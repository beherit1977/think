...
# test instances for code checking
st1 = Station.new('Mos')
st2 = Station.new('Pet')
...
tr2 = PassengerTrain.new('ccccc')

st1.add_train(tr1)

5.times { tr1.add_wagon(CargoWagon.new(100)) }
7.times { tr2.add_wagon(PassengerWagon.new(35)) }
...
until user_input == 13
  ...
  when 5
    ...
    def validate_choice(type)
      raise 'You must enter 1 or 2' unless [1, 2].include?(type)
    ...
    Train.trains_all[number] = if type == 1
